...
![Simple Kademlia DHT](simple-kademlia.png "Simple Kademlia DHT")
...
| File                     | Purpose                                                                                                 |
| ------------------------ | ------------------------------------------------------------------------------------------------------- |
| `jada.hachi`             | Jada application entry point, CLI, mode selection, request construction, and node lifecycle controls    |
| `native/jada_native.cpp` | Native Kademlia engine, sockets, routing, cryptography, storage, RPC protocol, threading, and snapshots |
| `json.hpp`               | Bundled nlohmann/json single-header library                                                             |
| `config.example.json`    | Example Jada node configuration                                                                         |
| `tests/smoke.sh`         | Basic lifecycle, key/value, and group operation tests                                                   |
| `ARCHITECTURE.md`        | Additional notes about the Hachi and native boundary                                                    |
